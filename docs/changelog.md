...
- Replace the ambiguous quick start with an exact release-package download-to-analysis workflow.
- Distinguish source checkout behavior from the bundled XML release behavior.
