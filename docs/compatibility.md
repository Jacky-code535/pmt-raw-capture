...
0.6.0 的 collector 可发现 Linux Intel PMT sysfs 暴露的区域，但“可发现”不等于“已验证解码”。正式资格范围是 AVC01 GNR 主机上观察并通过真实采集、精确 XML 匹配和内置解码的以下七组 schema。
